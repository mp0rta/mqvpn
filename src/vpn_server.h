#ifndef MPVPN_VPN_SERVER_H
#define MPVPN_VPN_SERVER_H

#include <stdint.h>
#include <netinet/in.h>
#include <event2/event.h>

typedef struct mpvpn_server_cfg_s {
...
int mpvpn_server_run(const mpvpn_server_cfg_t *cfg);

#endif /* MPVPN_VPN_SERVER_H */
