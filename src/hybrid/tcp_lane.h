 ...
 * -1 if tcp_max_flows exceeded (for to_tcp=1 this check happens BEFORE
 * lwIP sees the packet — reject-before-side-effect; the OTHER rejection
 * point, inside the lwIP accept callback, is Task 8's). */
